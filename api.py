...
def get_availability():
    if request.method == 'POST':
        ...
        errorids = ['#ContentPlaceHolder1_GirJungleTrail_lblErrorMessage',
        ...
        time.sleep(1.5)
        driver.execute_script("document.querySelectorAll('table input')[1].value=arguments[0]",
        ...
        txt = driver.execute_script(
            "return document.querySelector(arguments[0]).textContent", errorids[data['number']-1])
